...
import HandleCancelProcessService from '@/entities/handle-cancel-process/handle-cancel-process.service';
...
new Vue({
  ...
  provide: {
    ...
    handleCancelService: () => new HandleCancelService(),
    handleCancelProcessService: () => new HandleCancelProcessService(),
