  ...
  <div class="row justify-content-center">
    <div class="col-10">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="travelTutorialCallApp.travelPlanStartForm.home.createOrEditLabel"
          data-cy="TravelPlanStartFormCreateUpdateHeading"
          v-text="$t('travelTutorialCallApp.travelPlanStartForm.home.createOrEditLabel')"
        >
              ...
              <div v-if="travelPlanProcess.travelPlan">
                <div class="form-group">
                  <label
                    ...
                    v-text="$t('travelTutorialCallApp.travelPlanStartForm.name')"
                ...
                <div class="form-group">
                  <label
                    class="form-control-label"
                    v-text="$t('travelTutorialCallApp.travelPlanStartForm.startDate')"
                ...
                <div class="form-group">
                  <label
                    class="form-control-label"
                    v-text="$t('travelTutorialCallApp.travelPlanStartForm.endDate')"
