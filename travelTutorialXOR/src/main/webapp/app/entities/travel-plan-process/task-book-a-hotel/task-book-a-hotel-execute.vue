        ...
        <akip-show-task-instance :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialXorApp.taskBookAHotel.name')" for="task-book-a-hotel-name"
                >Name</label
              >
              <input
                type="text"
            ...
            <div class="form-group">
              <label
                ...
                v-text="$t('travelTutorialXorApp.taskBookAHotel.startDate')"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialXorApp.taskBookAHotel.endDate')" for="task-book-a-hotel-endDate"
                >End Date</label
              >
              <b-input-group class="mb-3">
                <b-form-input
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialXorApp.taskBookAHotel.hotelName')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialXorApp.taskBookAHotel.hotelBookingNumber')"
