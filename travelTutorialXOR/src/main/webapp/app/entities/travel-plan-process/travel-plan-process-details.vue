    ...
    <div class="col-10">
      <div v-if="travelPlanProcess.processInstance">
        <h2 class="jh-entity-heading" data-cy="travelPlanProcessDetailsHeading">
          <span v-text="$t('travelTutorialXorApp.travelPlanProcess.detail.title')">TravelPlanProcess</span> {{ travelPlanProcess.id }}
        </h2>
            ...
            <div class="card" v-if="travelPlanProcess.travelPlan">
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelTutorialXorApp.travelPlanProcess.name')">name</label>
                  <input
                    readonly
                    type="text"
                    class="form-control"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelTutorialXorApp.travelPlanProcess.startDate')">startDate</label>
                  <input
                    readonly
                    type="text"
                    class="form-control"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelTutorialXorApp.travelPlanProcess.endDate')">endDate</label>
                  <input
                    readonly
                    type="text"
                    class="form-control"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelTutorialXorApp.travelPlanProcess.hotelName')">hotelName</label>
                  <input
                    readonly
                    type="text"
                    class="form-control"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelTutorialXorApp.travelPlanProcess.hotelBookingNumber')"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelTutorialXorApp.travelPlanProcess.airlineCompanyName')"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelTutorialXorApp.travelPlanProcess.airlineTicketNumber')"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelTutorialXorApp.travelPlanProcess.carCompanyName')"
              ...
              <div class="card-body py-0">
                <div class="form-group">
                  <label class="form-control-label" v-text="$t('travelTutorialXorApp.travelPlanProcess.carBookingNumber')"
