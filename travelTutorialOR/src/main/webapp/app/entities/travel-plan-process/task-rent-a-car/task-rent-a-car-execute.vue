        ...
        <akip-show-task-instance :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialOrApp.taskRentACar.name')" for="task-rent-a-car-name">Name</label>
              <input
                type="text"
                class="form-control"
                name="name"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialOrApp.taskRentACar.startDate')" for="task-rent-a-car-startDate"
                >Start Date</label
              >
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialOrApp.taskRentACar.endDate')" for="task-rent-a-car-endDate"
                >End Date</label
              >
              <b-input-group class="mb-3">
                <b-form-input
            ...
            <div class="form-group">
              <label
                ...
                v-text="$t('travelTutorialOrApp.taskRentACar.carCompanyName')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialOrApp.taskRentACar.carBookingNumber')"
