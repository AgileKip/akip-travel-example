          ...
          <template v-slot:body>
            ...
            <div class="form-group">
              <label
                ...
                v-text="$t('travelTutorialApp.taskBuyFlightTickets.name')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialApp.taskBuyFlightTickets.startDate')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialApp.taskBuyFlightTickets.endDate')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialApp.taskBuyFlightTickets.airlineCompanyName')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialApp.taskBuyFlightTickets.airlineTicketNumber')"
