...
class CarResourceIT {
    ...
    private static final Integer DEFAULT_PASSANGERS = 1;
    private static final Integer UPDATED_PASSANGERS = 2;
    ...
    void createCar() throws Exception {
        ...
        assertThat(testCar.getPassangers()).isEqualTo(DEFAULT_PASSANGERS);
        assertThat(testCar.getBoodked()).isEqualTo(DEFAULT_BOODKED);
    ...
    void getAllCars() throws Exception {
        ...
        restCarMockMvc
            ...
            .andExpect(jsonPath("$.[*].passangers").value(hasItem(DEFAULT_PASSANGERS)))
    ...
    void getCar() throws Exception {
        ...
        restCarMockMvc
            ...
            .andExpect(jsonPath("$.passangers").value(DEFAULT_PASSANGERS))
    ...
    void putNewCar() throws Exception {
        ...
        assertThat(testCar.getPassangers()).isEqualTo(UPDATED_PASSANGERS);
        assertThat(testCar.getBoodked()).isEqualTo(UPDATED_BOODKED);
    ...
    void partialUpdateCarWithPatch() throws Exception {
        ...
        partialUpdatedCar.code(UPDATED_CODE).passangers(UPDATED_PASSANGERS).boodked(UPDATED_BOODKED).price(UPDATED_PRICE);
