<template>
  <div class="home row">
    <div class="col-md-9">
      <h1 class="display-4" v-text="$t('travelTutorialValApp.home.title')">Welcome, Java Hipster!</h1>
      <div>
      ...
      <p v-text="$t('travelTutorialValApp.home.question')">If you have any question on JHipster:</p>
      ...
      <ul>
        <li>
          <a
            ...
            v-text="$t('travelTutorialValApp.home.link.homepage')"
            >JHipster homepage</a
          >
        </li>
        <li>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            v-text="$t('travelTutorialValApp.home.link.stackoverflow')"
        ...
        <li>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            v-text="$t('travelTutorialValApp.home.link.bugtracker')"
        ...
        <li>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            v-text="$t('travelTutorialValApp.home.link.follow')"
      ...
      <p>
        <span v-text="$t('travelTutorialValApp.home.like')">If you like AgileKip Generator, don't forget to give us a star on</span>
        <a
          href="https://github.com/agilekip/generator-jhipster-agilekip"
          target="_blank"
          rel="noopener noreferrer"
          v-text="$t('travelTutorialValApp.home.github')"
          >GitHub</a
        >!
      </p>
    </div>
