    ...
    <div class="col-10">
      <div v-if="taskContext.taskInstance">
        <h2 id="page-heading" data-cy="TaskInstanceHeading">
          <span v-text="$t('travelTutorialEmsgApp.taskInstance.execute.title')" id="task-instance-heading">Task Execution</span>
        </h2>
          ...
          <template v-slot:body>
            ...
            <div class="form-group">
              <label
                ...
                v-text="$t('travelTutorialEmsgApp.taskBuyFlightTickets.name')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEmsgApp.taskBuyFlightTickets.startDate')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEmsgApp.taskBuyFlightTickets.endDate')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEmsgApp.taskBuyFlightTickets.airlineCompanyName')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEmsgApp.taskBuyFlightTickets.airlineTicketNumber')"
