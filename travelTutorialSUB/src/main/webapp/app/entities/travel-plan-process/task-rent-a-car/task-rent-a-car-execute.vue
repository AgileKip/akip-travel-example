    ...
    <div class="col-10">
      <div v-if="taskContext.taskInstance">
        <h2 id="page-heading" data-cy="TaskInstanceHeading">
          <span v-text="$t('travelTutorialSubApp.taskInstance.execute.title')" id="task-instance-heading">Task Execution</span>
        </h2>
        <akip-show-task-instance :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            <hr />
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialSubApp.taskRentACar.name')" for="task-rent-a-car-name"
                >Name</label
              >
              <input
                type="text"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialSubApp.taskRentACar.startDate')" for="task-rent-a-car-startDate"
                >Start Date</label
              >
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialSubApp.taskRentACar.endDate')" for="task-rent-a-car-endDate"
                >End Date</label
              >
              <b-input-group class="mb-3">
                <b-form-input
            ...
            <div class="form-group">
              <label
                ...
                v-text="$t('travelTutorialSubApp.taskRentACar.carCompanyName')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialSubApp.taskRentACar.carBookingNumber')"
