  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="loginProcessosApp.processDefinition.home.createOrEditLabel"
          data-cy="ProcessDefinitionCreateUpdateHeading"
          v-text="$t('loginProcessosApp.processDefinition.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group" v-if="processDefinition.id">
            <label class="form-control-label" v-text="$t('loginProcessosApp.processDefinition.name')" for="process-definition-name"
              >Name</label
            >
          ...
          <div class="form-group">
            <label
              ...
              v-text="$t('loginProcessosApp.processDefinition.specificationFile')"
          ...
          <div class="form-group">
            <div class="col-sm">
              <div class="custom-control custom-switch">
                <input
                  id="canBeManuallyStarted"
                  type="checkbox"
                  class="custom-control-input"
                  v-model="processDefinition.canBeManuallyStarted"
                />
                <label
                  class="custom-control-label"
                  v-text="$t('loginProcessosApp.processDefinition.canBeManuallyStarted')"
                  for="canBeManuallyStarted"
                >
          ...
          <div class="form-group">
            <div class="col-sm">
              <div class="custom-control custom-switch">
                <input id="requireATenant" type="checkbox" class="custom-control-input" v-model="processDefinition.requireATenant" />
                <label class="custom-control-label" v-text="$t('loginProcessosApp.processDefinition.requireATenant')" for="requireATenant">
                  Require A Tenant
                </label>
              </div>
            </div>
          </div>
          <div class="form-group" v-if="processDefinition.requireATenant">
            <label v-text="$t('loginProcessosApp.processDefinition.tenants')">Tenants</label>
            <multiselect
              id="tenants"
              v-model="processDefinition.tenants"
              :options="tenants"
              :multiple="true"
              group-label="Tenants"
              :group-select="true"
