  ...
  <div class="card">
    <div class="card-header page-header">
      <div class="d-flex justify-content-between">
        <h1 class="h3 text-black-50">Dashboard Config of the decision #{{ decisionDefinition.id }} - {{ decisionDefinition.name }}</h1>
      </div>
    </div>
    <br />
    <div class="card-body">
...
<script lang="ts" src="./decision-definition-dashboard-config.component.ts"></script>
