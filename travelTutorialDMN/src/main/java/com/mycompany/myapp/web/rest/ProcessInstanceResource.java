...
import br.com.loginlogistica.service.ProcessInstanceService;
import br.com.loginlogistica.service.RecaptchaService;
import br.com.loginlogistica.service.TaskInstanceService;
import br.com.loginlogistica.service.dto.ProcessInstanceBpmnModelDTO;
import br.com.loginlogistica.service.dto.ProcessInstanceDTO;
import br.com.loginlogistica.service.dto.TaskInstanceDTO;
import java.net.URI;
...
/**
 * REST controller for managing {@link br.com.loginlogistica.domain.ProcessInstance}.
 */
@RestController
@RequestMapping("/api")
public class ProcessInstanceResource {
     ...
     */
    @PostMapping("/admin/process-instances")
    ...
    /**
     * {@code GET  public/process-instances/:id/tasks} : get the "id" processInstance.
     *
     * @param id the id of the processInstance owner of the TaskInstances.
     * @return the list of processInstanceDTO, or with status {@code 404 (Not Found)}.
     */
    @GetMapping("/public/process-instances/{tokenAcessoNumero}/{id}/tasks")
    public List<TaskInstanceDTO> getTaskInstancesPublic(
        @PathVariable Long id,
        @PathVariable String tokenAcessoNumero,
        @RequestHeader String token
    ) {
        log.debug("REST request to get TaskInstances of ProcessInstance : {}", id);
        recaptchaService.checkCaptcha(token);
        return taskInstanceService.findByProcessInstancePublic(id, tokenAcessoNumero);
    }
