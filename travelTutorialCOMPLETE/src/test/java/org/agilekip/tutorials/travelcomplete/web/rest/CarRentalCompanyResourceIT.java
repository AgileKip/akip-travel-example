...
class CarRentalCompanyResourceIT {
    ...
    public static CarRentalCompany createEntity(EntityManager em) {
        CarRentalCompany carRentalCompany = new CarRentalCompany().name(DEFAULT_NAME).place(DEFAULT_PLACE);
    ...
    public static CarRentalCompany createUpdatedEntity(EntityManager em) {
        CarRentalCompany carRentalCompany = new CarRentalCompany().name(UPDATED_NAME).place(UPDATED_PLACE);
        return carRentalCompany;
    }
    ...
    void createCarRentalCompany() throws Exception {
        ...
        assertThat(testCarRentalCompany.getPlace()).isEqualTo(DEFAULT_PLACE);
    }
    ...
    void putNewCarRentalCompany() throws Exception {
        ...
        updatedCarRentalCompany.name(UPDATED_NAME).place(UPDATED_PLACE);
        ...
        assertThat(testCarRentalCompany.getPlace()).isEqualTo(UPDATED_PLACE);
    }
    ...
    void fullUpdateCarRentalCompanyWithPatch() throws Exception {
        ...
        partialUpdatedCarRentalCompany.name(UPDATED_NAME).place(UPDATED_PLACE);
