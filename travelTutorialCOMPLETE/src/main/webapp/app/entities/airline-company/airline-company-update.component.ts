    ...
    if (this.airlineCompany.id) {
      this.airlineCompanyService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('travelTutorialCompleteApp.airlineCompany.updated', { param: param.id });
      ...
      this.airlineCompanyService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('travelTutorialCompleteApp.airlineCompany.created', { param: param.id });
