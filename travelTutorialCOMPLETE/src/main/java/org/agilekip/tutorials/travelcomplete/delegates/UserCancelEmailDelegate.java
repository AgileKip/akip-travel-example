...
@Component
public class UserCancelEmailDelegate implements JavaDelegate {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        String subject = "[Travel Complete] User Cancel email " + travelPlan.getName();
        Context context = new Context(Locale.getDefault());
        context.setVariable("travelPlan", travelPlan);
        String content = templateEngine.process("travelPlanProcess/userCancelEmail", context);
