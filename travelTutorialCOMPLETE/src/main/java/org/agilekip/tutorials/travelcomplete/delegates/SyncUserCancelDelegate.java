...
@Component
public class SyncUserCancelDelegate implements JavaDelegate {

    private final TravelPlanRepository travelPlanRepo;

    public SyncUserCancelDelegate(TravelPlanRepository travelPlanRepository) {
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        ...
        travelPlanObj.setStatus(PlanStatus.CANCELED);
        travelPlanDTO.setStatus(PlanStatus.CANCELED);
