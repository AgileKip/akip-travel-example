...
import org.agilekip.tutorials.travelcomplete.service.AirlineCompanyService;
...
/**
 * REST controller for managing {@link org.agilekip.tutorials.travelcomplete.domain.AirlineCompany}.
 */
@RestController
@RequestMapping("/api")
public class AirlineCompanyResource {
    ...
    public ResponseEntity<AirlineCompanyDTO> createAirlineCompany(@Valid @RequestBody AirlineCompanyDTO airlineCompanyDTO)
    ...
    public ResponseEntity<AirlineCompanyDTO> updateAirlineCompany(
        ...
        @Valid @RequestBody AirlineCompanyDTO airlineCompanyDTO
    ) throws URISyntaxException {
    ...
    public ResponseEntity<AirlineCompanyDTO> partialUpdateAirlineCompany(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody AirlineCompanyDTO airlineCompanyDTO
    ) throws URISyntaxException {
