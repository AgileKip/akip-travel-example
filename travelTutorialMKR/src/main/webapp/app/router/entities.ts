...
export default [
  ...
  {
    path: '/process-definition/TravelPlanProcessSUB/init',
    name: 'TravelPlanStartFormInit',
    component: TravelPlanStartFormInit,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessSUB/instance/:processInstanceId/view',
    name: 'TravelPlanProcessView',
    component: TravelPlanProcessDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessSUB/instances',
    name: 'TravelPlanProcessList',
    component: TravelPlanProcessList,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessSUB/task/TaskHotel/:taskInstanceId/view',
    name: 'TravelPlanProcess_TaskBookAHotelDetails',
    component: TravelPlanProcess_TaskBookAHotelDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessSUB/task/TaskHotel/:taskInstanceId/execute',
    name: 'TravelPlanProcess_TaskBookAHotelExecute',
    component: TravelPlanProcess_TaskBookAHotelExecute,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessSUB/task/TaskFlight/:taskInstanceId/view',
    name: 'TravelPlanProcess_TaskBuyFlightTicketsDetails',
    component: TravelPlanProcess_TaskBuyFlightTicketsDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessSUB/task/TaskFlight/:taskInstanceId/execute',
    name: 'TravelPlanProcess_TaskBuyFlightTicketsExecute',
    component: TravelPlanProcess_TaskBuyFlightTicketsExecute,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessSUB/task/TaskCar/:taskInstanceId/view',
    name: 'TravelPlanProcess_TaskRentACarDetails',
    component: TravelPlanProcess_TaskRentACarDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessSUB/task/TaskCar/:taskInstanceId/execute',
    name: 'TravelPlanProcess_TaskRentACarExecute',
    component: TravelPlanProcess_TaskRentACarExecute,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessMKR/init',
    name: 'TravelPlanStartFormInit',
    component: TravelPlanStartFormInit,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessMKR/instance/:processInstanceId/view',
    name: 'TravelPlanProcessView',
    component: TravelPlanProcessDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessMKR/instances',
    name: 'TravelPlanProcessList',
    component: TravelPlanProcessList,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessMKR/task/TaskHotel/:taskInstanceId/view',
    name: 'TravelPlanProcess_TaskBookAHotelDetails',
    component: TravelPlanProcess_TaskBookAHotelDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessMKR/task/TaskHotel/:taskInstanceId/execute',
    name: 'TravelPlanProcess_TaskBookAHotelExecute',
    component: TravelPlanProcess_TaskBookAHotelExecute,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessMKR/task/TaskFlight/:taskInstanceId/view',
    name: 'TravelPlanProcess_TaskBuyFlightTicketsDetails',
    component: TravelPlanProcess_TaskBuyFlightTicketsDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessMKR/task/TaskFlight/:taskInstanceId/execute',
    name: 'TravelPlanProcess_TaskBuyFlightTicketsExecute',
    component: TravelPlanProcess_TaskBuyFlightTicketsExecute,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessMKR/task/TaskCar/:taskInstanceId/view',
    name: 'TravelPlanProcess_TaskRentACarDetails',
    component: TravelPlanProcess_TaskRentACarDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessMKR/task/TaskCar/:taskInstanceId/execute',
    name: 'TravelPlanProcess_TaskRentACarExecute',
    component: TravelPlanProcess_TaskRentACarExecute,
    meta: { authorities: [Authority.USER] },
  },
