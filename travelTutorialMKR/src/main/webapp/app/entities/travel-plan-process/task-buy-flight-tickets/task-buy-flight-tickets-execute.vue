    ...
    <div class="col-10">
      <div v-if="taskContext.taskInstance">
        <h2 id="page-heading" data-cy="TaskInstanceHeading">
          <span v-text="$t('travelTutorialMkrApp.taskInstance.execute.title')" id="task-instance-heading">Task Execution</span>
        </h2>
          ...
          <template v-slot:body>
            ...
            <div class="form-group">
              <label
                ...
                v-text="$t('travelTutorialMkrApp.taskBuyFlightTickets.name')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialMkrApp.taskBuyFlightTickets.startDate')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialMkrApp.taskBuyFlightTickets.endDate')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialMkrApp.taskBuyFlightTickets.airlineCompanyName')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialMkrApp.taskBuyFlightTickets.airlineTicketNumber')"
