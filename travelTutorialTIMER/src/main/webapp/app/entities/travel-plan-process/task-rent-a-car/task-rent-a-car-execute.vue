        ...
        <akip-show-task-instance :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialTimerApp.taskRentACar.name')" for="task-rent-a-car-name"
                >Name</label
              >
              <input
                type="text"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialTimerApp.taskRentACar.startDate')" for="task-rent-a-car-startDate"
                >Start Date</label
              >
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialTimerApp.taskRentACar.endDate')" for="task-rent-a-car-endDate"
                >End Date</label
              >
              <b-input-group class="mb-3">
                <b-form-input
            ...
            <div class="form-group">
              <label
                ...
                v-text="$t('travelTutorialTimerApp.taskRentACar.carCompanyName')"
                for="task-rent-a-car-carCompanyName"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialTimerApp.taskRentACar.carBookingNumber')"
