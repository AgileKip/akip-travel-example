...
export default [
  ...
  {
    path: '/process-definition/TravelPlanProcessTIMER/init',
    name: 'TravelPlanStartFormInit',
    component: TravelPlanStartFormInit,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessTIMER/instance/:processInstanceId/view',
    name: 'TravelPlanProcessView',
    component: TravelPlanProcessDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessTIMER/instances',
    name: 'TravelPlanProcessList',
    component: TravelPlanProcessList,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessTIMER/task/TaskHotel/:taskInstanceId/view',
    name: 'TravelPlanProcess_TaskBookAHotelDetails',
    component: TravelPlanProcess_TaskBookAHotelDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessTIMER/task/TaskHotel/:taskInstanceId/execute',
    name: 'TravelPlanProcess_TaskBookAHotelExecute',
    component: TravelPlanProcess_TaskBookAHotelExecute,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessTIMER/task/TaskFlight/:taskInstanceId/view',
    name: 'TravelPlanProcess_TaskBuyFlightTicketsDetails',
    component: TravelPlanProcess_TaskBuyFlightTicketsDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessTIMER/task/TaskFlight/:taskInstanceId/execute',
    name: 'TravelPlanProcess_TaskBuyFlightTicketsExecute',
    component: TravelPlanProcess_TaskBuyFlightTicketsExecute,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessTIMER/task/TaskCar/:taskInstanceId/view',
    name: 'TravelPlanProcess_TaskRentACarDetails',
    component: TravelPlanProcess_TaskRentACarDetails,
    meta: { authorities: [Authority.USER] },
  },
  {
    path: '/process-definition/TravelPlanProcessTIMER/task/TaskCar/:taskInstanceId/execute',
