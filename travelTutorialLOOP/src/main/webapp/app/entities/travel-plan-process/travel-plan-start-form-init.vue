  ...
  <div class="row justify-content-center">
    <div class="col-10">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="travelTutorialLoopApp.travelPlanStartForm.home.createOrEditLabel"
          data-cy="TravelPlanStartFormCreateUpdateHeading"
          v-text="$t('travelTutorialLoopApp.travelPlanStartForm.home.createOrEditLabel')"
        >
              ...
              <div v-if="travelPlanProcess.travelPlan">
                <div class="form-group">
                  <label
                    ...
                    v-text="$t('travelTutorialLoopApp.travelPlanStartForm.name')"
                ...
                <div class="form-group">
                  <label
                    class="form-control-label"
                    v-text="$t('travelTutorialLoopApp.travelPlanStartForm.startDate')"
                ...
                <div class="form-group">
                  <label
                    class="form-control-label"
                    v-text="$t('travelTutorialLoopApp.travelPlanStartForm.endDate')"
