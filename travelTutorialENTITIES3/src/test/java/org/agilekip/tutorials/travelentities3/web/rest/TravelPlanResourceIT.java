...
import org.agilekip.tutorials.travelentities3.repository.TravelPlanRepository;
import org.agilekip.tutorials.travelentities3.service.dto.TravelPlanDTO;
import org.agilekip.tutorials.travelentities3.service.mapper.TravelPlanMapper;
...
class TravelPlanResourceIT {
    ...
    private static final String DEFAULT_FINAL_REMARKS = "AAAAAAAAAA";
    private static final String UPDATED_FINAL_REMARKS = "BBBBBBBBBB";
    ...
    public static TravelPlan createEntity(EntityManager em) {
        TravelPlan travelPlan = new TravelPlan()
            ...
            .finalRemarks(DEFAULT_FINAL_REMARKS);
        return travelPlan;
    }
    ...
    public static TravelPlan createUpdatedEntity(EntityManager em) {
        TravelPlan travelPlan = new TravelPlan()
            ...
            .finalRemarks(UPDATED_FINAL_REMARKS);
        return travelPlan;
    }
    ...
    void getAllTravelPlans() throws Exception {
        ...
        restTravelPlanMockMvc
            ...
            .andExpect(jsonPath("$.[*].finalRemarks").value(hasItem(DEFAULT_FINAL_REMARKS)));
    }
    ...
    void getTravelPlan() throws Exception {
        ...
        restTravelPlanMockMvc
            ...
            .andExpect(jsonPath("$.finalRemarks").value(DEFAULT_FINAL_REMARKS));
    }
