...
import org.agilekip.tutorials.travelentities3.repository.TravelPlanProcessRepository;
...
import org.agilekip.tutorials.travelentities3.service.mapper.TravelPlanProcessMapper;
...
public class TaskBuyFlightTicketsService {
    ...
    public void save(TaskBuyFlightTicketsContextDTO taskBuyFlightTicketsContext) {
        ...
        travelPlanDTO.setAirlineCompany(taskBuyFlightTicketsContext.getTravelPlanProcess().getTravelPlan().getAirlineCompany());
