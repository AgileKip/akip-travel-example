          ...
          <template v-slot:body>
            ...
            <div class="form-group">
              <label
                ...
                v-text="$t('travelTutorialEntities3App.taskBuyFlightTickets.name')"
                for="task-buy-flight-tickets-name"
                >Name</label
              >
              <input
                type="text"
                class="form-control"
                name="name"
                id="task-buy-flight-tickets-name"
                readonly
                data-cy="name"
                :class="{
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEntities3App.taskBuyFlightTickets.startDate')"
                for="task-buy-flight-tickets-startDate"
                >Start Date</label
              >
              <b-input-group class="mb-3">
                <b-form-input
                  id="task-buy-flight-tickets-startDate"
                  readonly
                  data-cy="startDate"
                  type="text"
                  class="form-control"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEntities3App.taskBuyFlightTickets.endDate')"
                for="task-buy-flight-tickets-endDate"
                >End Date</label
              >
              <b-input-group class="mb-3">
                <b-form-input
                  id="task-buy-flight-tickets-endDate"
                  readonly
                  data-cy="endDate"
                  type="text"
                  class="form-control"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEntities3App.taskBuyFlightTickets.airlineTicketNumber')"
                for="task-buy-flight-tickets-airlineTicketNumber"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEntities3App.taskBuyFlightTickets.airlineCompany')"
                for="task-buy-flight-tickets-airlineCompany"
                >Airline Company</label
              >
              <select
                class="form-control"
                id="task-buy-flight-tickets-airlineCompany"
