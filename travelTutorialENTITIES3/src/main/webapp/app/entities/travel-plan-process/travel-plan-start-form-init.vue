  ...
  <div class="row justify-content-center">
    <div class="col-10">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="travelTutorialEntities3App.travelPlanStartForm.home.createOrEditLabel"
          data-cy="TravelPlanStartFormCreateUpdateHeading"
          v-text="$t('travelTutorialEntities3App.travelPlanStartForm.home.createOrEditLabel')"
        >
              ...
              <div v-if="travelPlanProcess.travelPlan">
                <div class="form-group">
                  <label
                    ...
                    v-text="$t('travelTutorialEntities3App.travelPlanStartForm.name')"
                ...
                <div class="form-group">
                  <label
                    class="form-control-label"
                    v-text="$t('travelTutorialEntities3App.travelPlanStartForm.startDate')"
                ...
                <div class="form-group">
                  <label
                    class="form-control-label"
                    v-text="$t('travelTutorialEntities3App.travelPlanStartForm.endDate')"
