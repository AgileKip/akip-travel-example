    ...
    <div class="col-10">
      <div v-if="taskContext.taskInstance">
        <h2 id="page-heading" data-cy="TaskInstanceHeading">
          <span v-text="$t('travelTutorialEntities3App.taskInstance.execute.title')" id="task-instance-heading">Task Execution</span>
        </h2>
        <akip-show-task-instance :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            <hr />
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialEntities3App.taskRentACar.name')" for="task-rent-a-car-name"
                >Name</label
              >
              <input
                type="text"
            ...
            <div class="form-group">
              <label
                ...
                v-text="$t('travelTutorialEntities3App.taskRentACar.startDate')"
                for="task-rent-a-car-startDate"
                >Start Date</label
              >
              <b-input-group class="mb-3">
                <b-form-input
                  id="task-rent-a-car-startDate"
                  readonly
                  data-cy="startDate"
                  type="text"
                  class="form-control"
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialEntities3App.taskRentACar.endDate')" for="task-rent-a-car-endDate"
                >End Date</label
              >
              <b-input-group class="mb-3">
                <b-form-input
                  id="task-rent-a-car-endDate"
                  readonly
                  data-cy="endDate"
                  type="text"
                  class="form-control"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEntities3App.taskRentACar.carBookingNumber')"
                for="task-rent-a-car-carBookingNumber"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEntities3App.taskRentACar.carRentalCompany')"
                for="task-rent-a-car-carRentalCompany"
                >Car Rental Company</label
              >
              <select
                class="form-control"
                id="task-rent-a-car-carRentalCompany"
                data-cy="carRentalCompany"
                name="carRentalCompany"
                v-model="taskContext.travelPlanProcess.travelPlan.carRentalCompany"
              >
                <option v-bind:value="null"></option>
                <option
                  v-bind:value="
                    taskContext.travelPlanProcess.travelPlan.carRentalCompany &&
                    carRentalCompanyOption.id === taskContext.travelPlanProcess.travelPlan.carRentalCompany.id
                      ? taskContext.travelPlanProcess.travelPlan.carRentalCompany
                      : carRentalCompanyOption
                  "
