    ...
    if (this.carRentalCompany.id) {
      this.carRentalCompanyService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('travelTutorialEntities2App.carRentalCompany.updated', { param: param.id });
      ...
      this.carRentalCompanyService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('travelTutorialEntities2App.carRentalCompany.created', { param: param.id });
