<template>
  <div>
    <h2 id="page-heading" data-cy="HotelCompanyHeading">
      <span v-text="$t('travelTutorialEntities2App.hotelCompany.home.title')" id="hotel-company-heading">Hotel Companies</span>
      <div class="d-flex justify-content-end">
        <button class="btn btn-info mr-2" v-on:click="handleSyncList" :disabled="isFetching">
          <font-awesome-icon icon="sync" :spin="isFetching"></font-awesome-icon>
          <span v-text="$t('travelTutorialEntities2App.hotelCompany.home.refreshListLabel')">Refresh List</span>
        </button>
        <router-link :to="{ name: 'HotelCompanyCreate' }" custom v-slot="{ navigate }">
          ...
          >
            ...
            <span v-text="$t('travelTutorialEntities2App.hotelCompany.home.createLabel')"> Create a new Hotel Company </span>
          </button>
        </router-link>
      </div>
    </h2>
    ...
    <div class="alert alert-warning" v-if="!isFetching && hotelCompanies && hotelCompanies.length === 0">
      <span v-text="$t('travelTutorialEntities2App.hotelCompany.home.notFound')">No hotelCompanies found</span>
    </div>
      ...
      <table class="table table-striped" aria-describedby="hotelCompanies">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('travelTutorialEntities2App.hotelCompany.name')">Name</span></th>
            <th scope="row"><span v-text="$t('travelTutorialEntities2App.hotelCompany.code')">Code</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
    ...
    <b-modal ref="removeEntity" id="removeEntity">
      <span slot="modal-title"
        ><span
          id="travelTutorialEntities2App.hotelCompany.delete.question"
      ...
      <div class="modal-body">
        <p id="jhi-delete-hotelCompany-heading" v-text="$t('travelTutorialEntities2App.hotelCompany.delete.question', { id: removeId })">
