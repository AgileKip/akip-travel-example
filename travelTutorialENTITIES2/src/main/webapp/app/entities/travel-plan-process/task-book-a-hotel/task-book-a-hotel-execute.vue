        ...
        <akip-show-task-instance :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('travelTutorialEntities2App.taskBookAHotel.name')" for="task-book-a-hotel-name"
                >Name</label
              >
              <input
                type="text"
            ...
            <div class="form-group">
              <label
                ...
                v-text="$t('travelTutorialEntities2App.taskBookAHotel.startDate')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEntities2App.taskBookAHotel.endDate')"
                for="task-book-a-hotel-endDate"
                >End Date</label
              >
              <b-input-group class="mb-3">
                <b-form-input
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEntities2App.taskBookAHotel.hotelBookingNumber')"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('travelTutorialEntities2App.taskBookAHotel.hotelCompany')"
                for="task-book-a-hotel-hotelCompany"
                >Hotel Company</label
              >
              <select
                class="form-control"
                id="task-book-a-hotel-hotelCompany"
                data-cy="hotelCompany"
                name="hotelCompany"
                v-model="taskContext.travelPlanProcess.travelPlan.hotelCompany"
              >
                <option v-bind:value="null"></option>
                <option
                  v-bind:value="
                    taskContext.travelPlanProcess.travelPlan.hotelCompany &&
                    hotelCompanyOption.id === taskContext.travelPlanProcess.travelPlan.hotelCompany.id
                      ? taskContext.travelPlanProcess.travelPlan.hotelCompany
                      : hotelCompanyOption
                  "
