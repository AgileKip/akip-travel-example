...
export default class TravelPlanStartFormInitComponent extends Vue {
  ...
  public bpmnProcessDefinitionId: string = 'TravelPlanProcessENTITIES2';
  ...
  public save(): void {
    ...
    this.travelPlanProcessService()
      ...
      .then(param => {
        this.isSaving = false;
        this.$router.go(-1);
        const message = this.$t('travelTutorialEntities2App.travelPlanStartForm.created', { param: param.id });
